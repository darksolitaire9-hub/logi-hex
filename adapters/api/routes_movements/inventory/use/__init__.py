...
from adapters.api.schemas.inventory.movements_use import UseMovementIn
...
async def create_use_movement(
    workspace_id: str,
    payload: UseMovementIn,
    facade: LogiFacade = Depends(get_facade),
    workspace=Depends(get_current_workspace),
):
    try:
        movement = await facade.use_stock(
